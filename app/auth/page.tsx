...
export default function Auth() {
  ...
  return (
    <main className="min-h-screen bg-gray-950 flex items-center justify-center px-4" style={{background:"radial-gradient(ellipse 60% 40% at 50% 0%, rgba(59,130,246,0.25) 0%, #030712 70%)"}}>
      <div className="w-full max-w-md">
        <div className="flex flex-col items-center mb-8">
          <div className="relative mb-4">
            <div className="absolute -inset-10 bg-blue-500 blur-3xl opacity-60 rounded-full" />
            <div className="absolute -inset-6 bg-blue-400 blur-2xl opacity-50 rounded-full" />
            <div className="absolute -inset-2 bg-blue-300 blur-lg opacity-30 rounded-full" />
            <div className="relative w-16 h-16 bg-gradient-to-br from-blue-400 to-blue-700 rounded-2xl flex items-center justify-center text-white font-bold text-3xl shadow-2xl shadow-blue-500/80">N</div>
          </div>
          <h1 className="text-3xl font-bold text-white mt-3">Nezro Academy</h1>
        </div>
        <div className="relative">
          <div className="absolute -inset-2 bg-blue-500 blur-3xl opacity-30 rounded-3xl" />
          <div className="absolute -inset-1 bg-blue-400 blur-xl opacity-20 rounded-3xl" />
          <div className="relative bg-gray-900/90 border border-blue-500/20 rounded-2xl p-8 backdrop-blur-sm">
            ...
            <div className="flex flex-col gap-4">
              ...
              <button onClick={handleSubmit} disabled={loading}
                className="bg-gradient-to-r from-blue-500 to-blue-700 text-white py-3 rounded-xl font-bold hover:from-blue-400 hover:to-blue-600 transition-all disabled:opacity-50 shadow-xl shadow-blue-600/50">
