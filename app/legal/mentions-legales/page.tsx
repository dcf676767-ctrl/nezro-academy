        ...
        <div className="flex flex-col gap-8">
          ...
          <section>
            ...
            <ul className="text-gray-400 flex flex-col gap-1">
              ...
              <li><strong className="text-white">Statut juridique :</strong> <span className="text-yellow-400">[INFORMATION À COMPLÉTER]</span></li>
              <li><strong className="text-white">Adresse :</strong> <span className="text-yellow-400">[INFORMATION À COMPLÉTER]</span></li>
